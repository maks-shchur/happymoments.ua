...
<div class="wrapper accaunt-container">
    <div class="container">
      ...
      <nav class="nav-accaunt">
        ...
        <span class="nav-accaunt__link_active __nav-accaunt__link-calendar" data-id="<?=$model->id;?>">КАЛЕНДАРЬ ЗАНЯТОСТИ</span>
      </nav>
<!-- ajax container -->
      <div class="accaunt-content__ajax clfx">
        <div class="accaunt-gallery-container">
          <?php
            $this->renderPartial('_calendar',array('model'=>$model));
          ?>  
