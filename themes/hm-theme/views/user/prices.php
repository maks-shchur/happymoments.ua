...
<div class="wrapper accaunt-container">
    <div class="container">
      ...
      <nav class="nav-accaunt">
        ...
        <a href="<?=Yii::app()->request->hostInfo?>/id<?=$model->id?>"><span class="nav-accaunt__link __nav-accaunt__link-portfolio" data-id="<?=$model->id;?>">ПОРТФОЛИО</span></a>
        <span class="nav-accaunt__link_active __nav-accaunt__link-cost" data-id="<?=$model->id;?>">ЦЕНЫ</span>
        <a href="<?=Yii::app()->request->hostInfo?>/id<?=$model->id?>/calendar" id="calendar"><span class="nav-accaunt__link __nav-accaunt__link-calendar" data-id="<?=$model->id;?>">КАЛЕНДАРЬ ЗАНЯТОСТИ</span></a>
      </nav>
<!-- ajax container -->
      <div class="accaunt-content__ajax clfx">
        <div class="accaunt-gallery-container">
          <?php
            $this->renderPartial('/prices/view',array('user'=>$model));
          ?>  
