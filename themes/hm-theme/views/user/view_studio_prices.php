        ...
        <table class="cabinet-pro__cost__table">
          ...
          <?php  
              for($i=($j-1)*3;$i<=($j-1)*3+2;$i++) {
                        if(isset($prices[$i])) {
          ?>
                        <th><?=$prices[$i]->title?><span>цена за час</span></th>
          <?php
                        }
                        else {
         ?>
         ...
         <?php                               
          ...
          <?php  
              for($i=($j-1)*3;$i<=($j-1)*3+2;$i++) {
                        if(isset($prices[$i])) {
          ?>
                        <td><?=$prices[$i]->price1?> грн<span>праздники, сб, вс - <?=$prices[$i]->price2?> грн</td>
          <?php
                        }
                        else {
         ?>
         ...
         <?php                               
          ...
          <?php
              ...
              foreach($prices as $item) {
              ?>
                    <td><?=$item->price1?> грн<span>праздники, сб, вс - <?=$item->price2?> грн</td>
              <?php  
              }
              ?>
                </tr> 
