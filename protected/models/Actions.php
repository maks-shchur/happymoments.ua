...
class Actions extends CActiveRecord
{
	...
	public function rules()
	{
		...
		return array(
			array('uid, picture, title, date_start, date_end, sale, price, description, conditions', 'required'),
			array('uid, sale, price', 'numerical', 'integerOnly'=>true),
			array('picture', 'file', 'types'=>'jpg,jpeg,gif,png', 'allowEmpty'=>false, 'safe'=>false),
