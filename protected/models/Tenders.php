...
class Tenders extends CActiveRecord
{
	...
	public function rules()
	{
		...
		return array(
			array('uid, occupation, genre, date_end, city, price, description, phone, email', 'required'),
	...
	public function attributeLabels()
	{
		return array(
			...
			'email' => 'E-mail',
            'date_create' => 'Дата создания тендера',
		);
	}
    ...
    public function getRowCssClass() { 
        ...
        if(isset($this->uid) && isset($this->date_end) && isset($this->phone) && isset($this->email)) {
            return 'order_ok';
        } else {
            return 'order_new';
        }  
