...
class Upload extends CWidget
{
	...
	public $css=null;
		...
		Yii::app()->clientScript->registerScriptFile($baseUrl . '/uploader.js', CClientScript::POS_HEAD);
                ...
                $this->css=(!empty($this->css))?$this->css:$baseUrl.'/uploader.css';
		...
		$config = CJavaScript::encode($config);
                Yii::app()->getClientScript()->registerScript("FileUploader_".$this->id, "var FileUploader_".$this->id." = new qq.FileUploader2($config); ",CClientScript::POS_LOAD);
	}
