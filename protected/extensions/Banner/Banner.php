...
class Banner extends CWidget
{
	...
	public $css=null;
		...
		Yii::app()->clientScript->registerScriptFile($baseUrl . '/uploader3.js', CClientScript::POS_HEAD);

                $this->css=(!empty($this->css))?$this->css:$baseUrl.'/uploader3.css';
		...
		$config = CJavaScript::encode($config);
                Yii::app()->getClientScript()->registerScript("FileUploader_".$this->id, "var FileUploader_".$this->id." = new qq.FileUploader3($config); ",CClientScript::POS_LOAD);
	}
