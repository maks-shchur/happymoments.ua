	...
	<div id="mainmenu">
		<?php $this->widget('zii.widgets.CMenu',array(
			'items'=>array(
                ...
                array('label'=>'CRM', 'url'=>array('/crm/index'), 'visible'=>Yii::app()->user->isCrm),
				array('label'=>'Города', 'url'=>array('/admin/city')),
                array('label'=>'Категории участников', 'url'=>array('/admin/occupation')),
                array('label'=>'Жанры', 'url'=>array('/admin/genre')),
                ...
                array('label'=>'Баннеры', 'url'=>array('/admin/banners/admin')),
