  ...
  <div class="wrapper wrapper-cabinet">
    <div class="container clfx">
          ...
          <ul>
            ...
            <?php if($model->member!=0):?>
                ...
                <?php elseif($model->occupation->templ=='rent_photo'):?>
                    ...
                    <li><?=CHtml::link('Оборудование','/my/studio/equip',array('class'=>'active'));?></li>
      ...
      <div class="clfx"></div>
        ...
        <div class="cabinet-pro__quipment">
          <div class="tender-title">оборудование</div>
          <div class="col-12 global__plus__btn-container" style="float: none;">
            <a href="/my/studio/addequip" class="global__plus__btn"><i></i><span>Добавить оборудование</span></a>
          </div>
          <?php
          if(count($equips)>0) {
          ...
          ?>
              ...
              <div class="cabinet-pro__quipment__item clfx">
                <figure class="edit__equipment__item__img">
                  <div class="edit__equipment__item__img-cont">
                    <?php if(is_file($_SERVER['DOCUMENT_ROOT'] . '/users/'.$model->id.'/'.$item->photo)): ?>
                        <img src="/users/<?=$model->id?>/<?=$item->photo?>" alt="" />
                    <?php else: ?>
                ...
                <div class="edit__equipment__item__info">
                  ...
                  <a href="/my/studio/equipedit/id/<?=$item->id?>" class="cabinet__photo__item-edit"></a>
                  ...
                  <div class="nano" style="height: 220px;">
                      <div class="nano-content">
                        <div style="max-width: 593px;word-break: break-word;"><?=$item->description?></div>
                      </div>
                  </div>
                </div>
              </div>
                ...
                $('#<?=$item->id?>').click(function(){
                    $('.delete__hidden').hide();
                    $.ajax({
                        url: '/my/studio/delequip/id/<?=$item->id.'?back_url='.Yii::app()->request->requestUri?>',          
                        type : "get",                     
          ...
          <?php      
            ...
            echo Yii::t('studio','No equips found.');
          ?>
