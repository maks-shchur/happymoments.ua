          ...
          <ul>
            ...
            <?php if($model->member!=0):?>
                ...
                <?php elseif($model->occupation->templ=='rent_photo'):?>
                    ...
                    <li><?=CHtml::link('Аренда','/my/studio/rent',array('class'=>'active'));?></li>
          ...
          <nav class="cabinet__second-menu">
            <ul>
              ...
              <li><?=CHtml::link('Настройки','/my/profile/settings');?></li>
                ...
                <div class="cabinet-pro__service">
                  <div class="tender-title">аренда</div>
                  <div class="col-12 global__plus__btn-container" style="float: none;">
                    <a href="/my/studio/addrenttext" class="global__plus__btn"><i></i><span>Добавить текстовый блок</span></a>
                  </div>
                  <?php
                  if(count($texts)>0) {
                  ...
                  ?>
                    ...
                    <div class="cabinet-pro__service__item clfx">
                        <div class="cabinet-pro__service__item__text" style="width: 100%; padding-bottom:10px; padding-right: 5px; height: auto;">
                          <a href="/my/studio/textshow/id/<?=$item->id?>" class="cabinet__photo__item-view"></a>
                          <a href="/my/studio/textedit/id/<?=$item->id?>" class="cabinet__photo__item-edit"></a>
                    ...
                    $('#<?=$item->id?>').click(function(){
                        $('.delete__hidden').hide();
                        $.ajax({
                            url: '/my/studio/deltext/id/<?=$item->id.'?back_url='.Yii::app()->request->requestUri?>',          
                            type : "get",                     
                  ...
                  else echo Yii::t('studio','No texts found.');
                  ?>
                </div>
