...
<?php $form=$this->beginWidget('CActiveForm', array(
            ...
            'method'=>'post',
            'htmlOptions' => array('enctype' => 'multipart/form-data','onsubmit'=>'apply();'),
      )); ?> 
    ...
    <!--div class="default-input__container">
      <div class="col-275">
        <?php echo $form->labelEx($model,'occupation_id',array('class'=>'default-input__label')); ?>
      </div>
      <div class="col-384">
        ...
        <?php echo $form->dropDownList($model,'occupation_id',CHtml::listData(Occupation::model()->findAll(),'id','name')
                                        ...
                                        array(
                                            ...
                                            'ajax' => array(
                                                ...
                                                'url'=>CController::createUrl('profile/genresublist'), //url to call.
    ...
    <div class="default-input__container">
      <div class="col-275">
        <?php echo $form->labelEx($model,'genre_id',array('class'=>'default-input__label')); ?>
      </div>
      <div class="col-384">
        <?php 
        ...
        ?>
        <?php echo $form->checkBoxList($model, 'genre_id', CHtml::listData(Genre::model()->findAll('occ_id=:occ_id', array(':occ_id'=>(int) $model->occupation_id)), 'id', 'name'),array('class'=>'default-input__radio')); ?>
        <?php echo $form->error($model,'genre_id',array('style'=>'margin-top: 5px;')); ?>
      </div>
    </div>
    <!--div class="default-input__container">
      <div class="col-275">
