  ...
  <div class="wrapper wrapper-cabinet">
    <div class="container clfx">
      ...
      <div class="clfx"></div>
          ...
          <nav class="cabinet__second-menu">
            <ul>
              ...
              <?php if($model->member_type!='basic'):?>
                    <li class="active"><?=CHtml::link('Мои акции','/my/actions/');?></li>
                <?php endif;?>
        ...
        <div class="cabinet-pro__action__list clfx">
          <header class="cabinet__portfolio__title clfx">
            <div class="col-4"></div>
            <div class="col-4"><h3>АКЦИИ</h3></div>
            <div class="col-4"></div>
          </header>
          <div class="col-12 global__plus__btn-container">
            <?=CHtml::link('<i></i><span>Добавить акцию</span>','/my/actions/create',array('class'=>'global__plus__btn'))?>
          </div>
        <?php $this->widget('zii.widgets.CListView', array(
        	'dataProvider'=>$dataProvider,
        	'itemView'=>'_view',
            'emptyText'=>Yii::t('actions','No results found.')
        )); ?>
        </div>
