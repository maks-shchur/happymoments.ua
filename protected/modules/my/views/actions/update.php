  ...
  <div class="wrapper wrapper-cabinet">
    <div class="container clfx">
      ...
      <div class="clfx"></div>
        ...
        <div class="cabinet-pro__add-action">
          <div class="tender-title-edit clfx">
            <div class="col-4"><a href="/my/actions/">Все акции</a></div>
            <div class="col-4">Редактирование акции</div>
            <div class="col-4"></div>
          </div>
          <?php $this->renderPartial('_form', array('model'=>$action)); ?>  
        </div>
