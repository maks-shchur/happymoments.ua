...
<div class="cabinet-pro__quipment__item cabinet-pro__quipment__item-1 clfx">
    ...
    <div class="edit__equipment__item__info">
      ...
      <a href="/my/portfolio/update/id/<?=$data->id?>" class="cabinet__photo__item-edit"></a>
      ...
      <div class="flo__price_profile"><?=$data->price?> грн/час</div>
    </div>
</div>
</div>
<script>
$('#<?=$data->id?>').click(function(){
    $('.delete__hidden').hide();
    $.ajax({
        url: '/my/portfolio/delete/id/<?=$data->id?>',          
        type : "get",                     
