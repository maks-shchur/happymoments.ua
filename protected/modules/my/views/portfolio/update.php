  ...
  <div class="wrapper wrapper-cabinet">
    <div class="container clfx">
      ...
      <div class="clfx"></div>
          ...
          <nav class="cabinet__second-menu">
            <ul>
              ...
              <?php if($user->member_type!='basic'):?>
                    <li><?=CHtml::link('ои акции','/my/actions/');?></li>
                <?php endif;?>
        ...
        <div class="cabinet-pro__edit__equipment">
          <header class="cabinet__portfolio__title clfx">
            <div class="col-4 albom-name"><a href="/my/portfolio" class="pro__action__open__all">Все элементы</a></div>
            <div class="col-4"><h3>Редактирование элемента</h3></div>
            <div class="col-4"></div>
          </header>
            <?php 
            //if($user->genre_id=='') $this->renderPartial('_form_user', array('model'=>$model));
            //else $this->renderPartial('_edit_album', array('model'=>$model));
            
            $this->renderPartial('_form_user', array('model'=>$model)); 
            ?>
