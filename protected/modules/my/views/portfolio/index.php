    ...
    <div class="container clfx">
          ...
          <ul>
            ...
            <?php if($user->member!=0):?>
                <?php if($user->occupation->templ=='members'):?>
                    <li><?=CHtml::link('Портфолио','/my/portfolio/',array('class'=>'active'));?></li>
      ...
      <div class="clfx"></div>
        ...
        <div id="cabiner__gallery__select">
          <h3 class="cabinet__accordion__title">Фото альбомы</h3>
            <div class="cabinet__photo__list">
              ...
              <div class="clfx"></div>
                ...
                <figure class="cabinet__photo__item">
                  <a href="/my/portfolio/album/id/<?=$item->id;?>">
                    <?php if($item->picture!=''): ?>
                  ...
                  <a href="/my/portfolio/visible/id/<?=$item->id?>" class="cabinet__photo__item-view"></a>
                  <a href="/my/portfolio/album/id/<?=$item->id?>" class="cabinet__photo__item-edit"></a>
                  ...
                  <?php
                  if($item->visible==0 || count($item->files)<=0): 
                  ?>
                  <a href="/my/portfolio/album/id/<?=$item->id?>">
                ...
                $('#<?=$item->id?>').click(function(){
                    $('.delete__hidden').hide();
                    $.ajax({
                        url: '/my/portfolio/delete/id/<?=$item->id.'?back_url='.Yii::app()->request->requestUri?>',          
                        type : "get",                     
