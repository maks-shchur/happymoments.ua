      ...
      <div class="clfx"></div>
        ...
        <main class="cabinet__portfolio">
          <header class="cabinet__portfolio__title clfx">
            <div class="col-4 albom-name"><a href="/my/portfolio">все альбомы</a></div>
          ...
          <div class="col-3 cabinet__portfolio__add-photo">      
            <div class="col-12 global__plus__btn-container">
                ...
                array(
                        'id'=>'uploadFiles',
                        'config'=>array(
                               'action'=>Yii::app()->createUrl('/my/portfolio/upload/id/'.$_GET['id']),
                               'allowedExtensions'=>array("jpg","jpeg","gif","png"),//array("jpg","jpeg","gif","exe","mov" and etc...
                               'sizeLimit'=>8*1024*1024,// maximum file size in bytes
                               'minSizeLimit'=>1*1024,
                               'auto'=>true,
          ...
          <div class="clfx"></div>
                ...
                <?php $form=$this->beginWidget('CActiveForm', array(
                    	'id'=>'files-form',
                        'action'=>'/my/portfolio/updatefiles/',
