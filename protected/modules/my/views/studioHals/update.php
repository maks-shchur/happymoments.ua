    ...
    <div class="container clfx">
      ...
      <div class="clfx"></div>
        ...
        <div class="tender-title-edit clfx">
          <div class="col-4"><a href="/my/studio/prices">Все цены</a></div>
          <div class="col-4">Редактировать стоимость</div>
          <div class="col-4"></div>
        </div>
        <div class="col-4"></div>
        
        <?php $this->renderPartial('/studioHals/_form',array('model'=>$m)); ?>                
