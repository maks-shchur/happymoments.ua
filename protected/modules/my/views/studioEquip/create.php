          ...
          <ul>
            ...
            <?php if($model->member!=0):?>
                ...
                <?php elseif($model->occupation->templ=='rent_photo'):?>
                    ...
                    <!--i><?=CHtml::link('Календарь занятости','/my/calendar/');?></li-->
                <?php else: ?>
                    <li><?=CHtml::link('Портфолио','/my/portfolio/');?></li>
                <?php endif;?>
            <?php endif; ?>
          ...
          <nav class="cabinet__second-menu">
            ...
            <div class="cabinet-pro__edit__equipment">
              <header class="cabinet__portfolio__title clfx">
                <div class="col-4 albom-name"><a href="/my/studio/equip" class="pro__action__open__all">Все оборудование</a></div>
                <div class="col-4"><h3>Добавление оборудования</h3></div>
                <div class="col-4"></div>
              </header>
                <?php $this->renderPartial('/studioEquip/_form', array('model'=>new StudioEquip)); ?>
