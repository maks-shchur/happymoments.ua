  ...
  <div class="wrapper wrapper-cabinet">
    <div class="container clfx">
          ...
          <ul>
            ...
            <?php if($user->member!=0):?>
                ...
                <?php elseif($user->occupation->templ=='flo'):?>
                    <li><?=CHtml::link('Продукция','/my/flo/',array('class'=>'active'));?></li>
                <?php else: ?>
                    <li><?=CHtml::link('Портфолио','/my/portfolio/');?></li>
                <?php endif;?>
      ...
      <div class="clfx"></div>
        ...
        <div class="cabinet-pro__quipment flo">
            <div class="tender-title">магазин</div>
            <div class="col-12 global__plus__btn-container border__bottom-grey">
                <a href="/my/flo/create" class="global__plus__btn"><i></i><span>Добавить товар</span></a>
            </div>
            <?php $this->widget('zii.widgets.CListView', array(
            	'dataProvider'=>$dataProvider,
            	'itemView'=>'_view',
                'htmlOptions'=>array('style'=>'display:inline-block;'),
                'emptyText'=>Yii::t('flo','No results found.')
            )); ?>
