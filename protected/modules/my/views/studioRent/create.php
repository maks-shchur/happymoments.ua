          ...
          <nav class="cabinet__second-menu">
            ...
            <div class="cabinet-pro__edit__equipment">
              <header class="cabinet__portfolio__title clfx">
                <div class="col-4 albom-name"><a href="/my/studio/rent" class="pro__action__open__all">Все тексты</a></div>
                <div class="col-4"><h3>Добавление текстового блока</h3></div>
                <div class="col-4"></div>
              </header>
                <?php $this->renderPartial('/studioRent/_form', array('model'=>new StudioRent)); ?>
