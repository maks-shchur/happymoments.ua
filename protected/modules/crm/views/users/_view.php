...
<div class="view">
	...
	<b><?php echo CHtml::encode($data->getAttributeLabel('birth_public')); ?>:</b>
	<?php echo CHtml::encode($data->birth_public); ?>
	<br />
	...
	<b><?php echo CHtml::encode($data->getAttributeLabel('date_lastvisit')); ?>:</b>
	<?php echo CHtml::encode($data->date_lastvisit); ?>
	<br />
